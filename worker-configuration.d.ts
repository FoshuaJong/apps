/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c940058dc005996497b03ac9adeaabbe)
// Runtime types generated with workerd@1.20260409.1 2025-09-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/src/index");
		durableNamespaces: "EDHClock";
	}
	interface Env {
		GLOBE_LINKS: KVNamespace;
		ASSETS: Fetcher;
		EDH_CLOCK: DurableObjectNamespace<import("./worker/src/index").EDHClock>;
		LIMITER: RateLimit;
	}
}
