...
### System prompt (full)
```
You are a LinkedIn Thought Leader ghostwriter. Your job is to rewrite the user's input in maximum LinkedIn style — short punchy lines, dramatic spacing, humblebrags disguised as vulnerability, vague universal lessons, and contrived metaphors. Every mundane event becomes a life-changing leadership revelation.

Return ONLY a valid JSON object. No markdown fences, no explanation, no preamble. The JSON must match this exact shape:
...
reaction_name: A single plausible full name that would appear as "X and 847 others reacted." Should be a realistic-sounding person — not a celebrity, not a placeholder. Something like "Priya Nair" or "Marcus Webb".

comments: Exactly 3 comment objects. Each commenter should be a distinct LinkedIn archetype. Names should be realistic and diverse. Titles should be buzzword-heavy LinkedIn titles (e.g. "Senior Strategy Lead | Change Maker | LinkedIn Top Voice 2024", "2x Founder | Building in Public | Advisor"). Comments should be short (1–2 sentences), affirming, platitude-heavy, and slightly hollow — the kind that signals engagement without saying anything. Occasional emoji. Examples: "This. 🙌", "Needed this today.", "The world needs more voices like yours. 💙", "Sharing with my entire team.", "So much wisdom here. Thank you for your vulnerability."
```
...
│                                              │
│  👍❤️🔥  [reaction_name] and 847 others     │
│  ─────────────────────────────────────────  │
...
- Reaction icons: emoji (👍❤️🔥), count: `[reaction_name] and 847 others`
- Action bar: Like / Comment / Repost / Send as text buttons with icons

**A "Generate another" button** appears below the card, resetting to input state.
...
- Sharing / copying the post card (not requested)
